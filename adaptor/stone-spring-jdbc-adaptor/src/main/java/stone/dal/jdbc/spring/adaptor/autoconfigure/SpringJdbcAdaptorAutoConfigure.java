...
import stone.dal.jdbc.spring.adaptor.impl.JdbcSequenceSpiAdapterImpl;
...
public class SpringJdbcAdaptorAutoConfigure {
  ...
  @Bean
  public SequenceSpi getJdbcSequenceSpiAdapter(@Autowired EntityMetaManager entityMetaManager, @Autowired SequenceManager sequenceManager){
      return new JdbcSequenceSpiAdapterImpl(entityMetaManager,sequenceManager);
  }
  ...
  @Bean
  public JdbcDmlRunner getDmlRunner(@Autowired NamedParameterJdbcTemplate jdbcTemplate, @Autowired EntityMetaManager metaManager, @Autowired RdbmsEntityManager rdbmsEntityManager, @Autowired SequenceSpi jdbcSequenceSpiAdapterImpl) {
    return new JdbcDmlRunnerImpl(jdbcTemplate,metaManager,rdbmsEntityManager, jdbcSequenceSpiAdapterImpl);
  }
