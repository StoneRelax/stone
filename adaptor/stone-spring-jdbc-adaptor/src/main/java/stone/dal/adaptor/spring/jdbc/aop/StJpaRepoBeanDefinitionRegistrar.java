...
public class StJpaRepoBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {

  private static Logger logger = LoggerFactory.getLogger(StJpaRepoBeanDefinitionRegistrar.class);
  ...
  private StJpaRepoMethodFilter jpaRepositoryMethodFilter;

  private StJpaRepoMethodInterceptor jpaRepositoryMethodInterceptor;

  public StJpaRepoBeanDefinitionRegistrar() {
    jpaRepositoryMethodFilter = new StJpaRepoMethodFilter();
    jpaRepositoryMethodInterceptor = new StJpaRepoMethodInterceptor();
  }
  ...
  public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry)  {
    ...
    for (Class<?> repositoryClazz : doRepositories) {
      ...
      for(Method method : methods){
        StJpaRepoMethodPartRegistry.getInstance().registerMethod(method, DalAopUtils.getDoClass(repositoryClazz));
      }
